...
//  Definiciones
	...
	*/
	...
	$filename 			= "dump $fecha livianos.sql";
...
//  No tocar
	...
	define( 'Str_DATE', "18 de Marzo de 2014" );
//------------------------------------------------------------------------------------------
?>
<?php 
...
<?php
		...
		echo( "<br>&copy;2005 <a href=\"https://twitter.com/cesar_garces\">@cesar_garces</a><br>" );
...
<?php
		...
		if( !$result ) {
			...
			if( !$filehandle ) {
				...
				if( !$hay_Zlib ) 
					...
					gzwrite( $filehandle, $tabledump );	
				$tabledump = "-- Version: " . Str_VERS . ", del " . Str_DATE . ", https://twitter.com/cesar_garces\n";
				if( !$hay_Zlib ) 
					fwrite( $filehandle, $tabledump );
				else
					gzwrite( $filehandle, $tabledump );	
				$tabledump = "-- Soporte y Updaters: https://twitter.com/cesar_garces\n";
				if( !$hay_Zlib ) 
					fwrite( $filehandle, $tabledump );
				else
					gzwrite( $filehandle, $tabledump );	
	...
	date_default_timezone_set("America/Bogota");
	echo strftime( "%A %d %B %Y&nbsp;-&nbsp;%H:%M:%S", time() );
	echo( "<br>&copy;2014 <a href=\"https://twitter.com/cesar_garces\">@cesar_garces</a><br>" );
	echo( "vers." . Str_VERS . "<br>" );
	echo( "</small></center>" );
	echo( "</BODY>" );
	echo( "</HTML>" );
