        ...
        <table align="center" class="table table-striped" border="1">
            ...
            <thead>
                ...
                <tr>
                  ...
                  <form action="entrada_devolucion_total.php" method="post">
                  <tr>
                  <th colspan="6" align="center">Insumo: 
                    <input type="text" id="buscar" autofocus name="insumo" autocomplete="off" />&nbsp;<div id="resultados_ajax"></div></th>
                    <th colspan="9" align="center">Obra: 
                      <input type="text" id="buscar2" name="obra" autocomplete="off" />&nbsp;
