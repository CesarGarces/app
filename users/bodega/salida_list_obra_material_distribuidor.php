	...
	if(mysql_num_rows($result)!= 0){
		...
		if(isset($_POST['material'])){
			...
			if(mysql_num_rows($result)!= 0){
				...
				//var_dump($material['proov']);
				
				
				
				$result = $objSal->list_salidas_obra_material($obra['codigo'],$material['codigo']);
       ...
       <div class="table-responsive"> 
        <table align="center" class="table table-striped" border="1">
            ...
            <thead>
                  ...
                  <form action="salida_list_obra_material_distribuidor.php" method="post">
                  <tr>
                  ...
                  <th colspan="4" align="center">Ingrese el material: 
                    <div >
                    <input id="buscar2" type="text"  name="material" autocomplete="off"/>&nbsp;<input type="submit" value="Buscar" />
            ...
            <tbody>
				...
				?>
                    	...
                    	<tr>
                            ...
                            <td colspan="3"><?php echo $material["proov"];?></td>
