...
<html lang="es">
  ...
  <link rel="icon" type="image/x-icon" href="../../favicon.ico">
    ...
    <div class="container">
        ...
        <form name="newProv" action="new_prov_exe.php" method="post">
        <table align="center" border="1">
        	...
        	<tbody>
                ...
                <tr>
                    <td><input type="text" name="codigo" placeholder="Codigo del Proveedor" /></td>
                    <td><input type="text" name="nombre" placeholder="Nombre" /></td>
                    <td><input type="text" name="contacto" placeholder="Contacto"/></td>
