        	...
        	<tbody>
				...
				if($num_rows > 0){
					...
					if($row=mysql_fetch_array($single_prod)){ ?>
						...
						<tr>
                            <td><input type="text" disabled name="codigo" value="<?php echo $row["codigo"];?>" /></td>
                            <td><input type="text" disabled name="nombre" value="<?php echo $row["nombre"];?>" /></td>
                            <td><input type="text" disabled name="unidad" value="<?php echo $row["unidad"];?>" /></td>
                            <td><input type="text" name="cantidad" value="<?php echo $row["cantidad"];?>" /></td>
                            <td><input type="text" name="minimo" value="<?php echo $row["minimo"];?>" /></td>
