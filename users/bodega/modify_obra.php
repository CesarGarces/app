...
$single_obra = $objOb->single_obra($codProd);
...
<html lang="es">
   ...
   <link rel="icon" type="image/x-icon" href="../../favicon.ico">
    ...
    <form name="modOb" action="modify_obra_exe.php" method="post">
        ...
        <td>Celular</td>
        	...
        	<tbody>
				...
				$num_rows = mysql_num_rows($single_obra);
				
				if($num_rows > 0){
					
					if($row=mysql_fetch_array($single_obra)){ ?>
						
						<tr>
                            <td><input type="text" name="codigo" value="<?php echo $row["codigo"];?>" /></td>
                            <td><input type="text" name="nombre" value="<?php echo $row["nombre"];?>" /></td>
                            <td><input type="text" name="responsable" value="<?php echo $row["responsable"];?>" /></td>
