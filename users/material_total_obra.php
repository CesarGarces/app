       ...
       <div class="table-responsive"> 
        <table align="center" class="table table-striped" border="1">
            ...
            <tbody>
				...
				$numrows = mysql_num_rows($list_material);
				
				if($numrows > 0){
					
					while($row=mysql_fetch_array($list_material)){?>
                    	...
                    	<tr>
                            ...
                            <td width="59"><a href="modify_mat.php?codProd=<?php echo $row["codigo"];?>">Modificar</a></td>
							<td><a href="delete_mat.php?codProd=<?php echo $row["codigo"];?>">Eliminar</a></td>
                        </tr>
